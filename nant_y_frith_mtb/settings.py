"""
Django settings for nant_y_frith_mtb project.
...
ROOT_URLCONF = 'nant_y_frith_mtb.urls'
...
if 'USE_AWS' in os.environ:
    ...
    # bucket config
    AWS_STORAGE_BUCKET_NAME = 'nant-y-frith-mtb'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'nant-y-frith-mtb@example.com'
else:
